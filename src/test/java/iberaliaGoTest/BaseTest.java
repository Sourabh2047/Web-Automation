...
public class BaseTest {
    ...
    public void globalSetup() {
        LoggerUtil.log("************************** IberaliaGo Test Execution Started ************************************");
    ...
    protected void setup(@Optional("chrome") String browser, @Optional("env") String env) {
        ...
        getURL(TestData.getDataValue("IberaliaGoBaseUrl", env));
    }
    ...
    public void wrapAllUp(ITestContext context) {
        ...
        LoggerUtil.log("************************** IberaliaGo Test Execution Finished ************************************");
    }
}